...
const unsigned long channel_id = 1734598; // CH ID
const char write_api_key[] = "SOE586O0I80F17TY";// API key LOOK INNTO API KEYS TAB
...
noTone(buzzer);
 ...
 if (fall==true){ //in event of a fall detection
   ...
   Serial.println("Posting " + String(fall = 1) + " to ThingSpeak");
   ThingSpeak.setField(1, String(fall, 2));
   Serial.println();
   ...
   delay(100000);
   fall=false;
   Serial.println("Posting " + String(fall = 0) + " to ThingSpeak");
   ThingSpeak.setField(1, String(fall, 2));
   Serial.println();
  // exit(1);
   }
